...
\end{lstlisting}
        ...
        \begin{center}
          \begin{tikzpicture}[node distance=2cm]
            ...
            \node[circle, draw, minimum size=1cm, right = 2.5cm of n2, dashed, label=above:{$\frac{n}{2^i}$}] (ndots) {$\log(\frac{n}{2^i})$};
            \node[circle, draw, minimum size=1cm, right = 2.5cm of ndots, label=above:{$4$}] (n4) {$\log(4)$};
            \node[circle, draw, minimum size=1cm, right of=n4, label=above:{$2$}] (n5) {$\log(2)$};
            \node[circle, draw, minimum size=1cm, right of=n5, label=above:{$1$}] (n6) {$1$};
